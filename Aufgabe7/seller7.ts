...
namespace A7 {
    ...
    export let christmasBalls: Products[] = [{ name: "Select your balls,", price: 0 }, { name: "red,", price: 7.99 }, { name: "gold,", price: 9.99 }, { name: "silver,", price: 9.99 }];
    export let candles: Products[] = [{ name: "Select your candles,", price: 0 }, { name: "red,", price: 4.99 }, { name: "gold,", price: 5.99 }, { name: "silver,", price: 5.99 }];
    export let ornaments: Products[] = [{ name: "Select your ornaments,", price: 0 }, { name: "shooting star,", price: 4.99 }, { name: "santa claus,", price: 6.99 }, { name: "snowflake,", price: 2.99 }];
    export let lametta: Products[] = [{ name: "Select your lametta,", price: 0 }, { name: "red,", price: 1.99 }, { name: "gold,", price: 2.99 }, { name: "silver,", price: 2.99 }];

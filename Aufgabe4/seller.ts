...
export interface Products {
    ...
    export let ornaments: Products[] = [{name: "Select your ornaments,", price: 0}, {name: "star,", price: 3.99}, {name: "shooting star,", price: 4.99}, {name: "present,", price: 2.99}, {name: "bell,", price: 3.99}, {name: "santa claus,", price: 6.99}, {name: "snowflake,", price: 2.99}];
